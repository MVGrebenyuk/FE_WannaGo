Dialog=function(a){
	...
	if(!d.tpl)d.tpl='<div class="dialog" id="{id}"><a onclick="Dialog.objects[\'{id}\'].close()" class="dialog-close"></a><div class="dialog-title">{title}</div><div class="dialog-data">{data}</div><div class="dialog-caption">{caption}</div></div>';
