Gallery=function(id){
	...
	this.nom=0;
	this.a=[];
	this.tpl='<div class="dialog" id="{id}"><a onclick="Dialog.objects[\'{id}\'].close()" class="dialog-close"></a><div class="dialog-title">{title}</div><div class="dialog-data"><a class="dialog-next" href="javascript:Gallery.objects[\''+this.id+'\'].next(1)"></a><a class="dialog-prev" href="javascript:Gallery.objects[\''+this.id+'\'].next(-1)"></a>{data}</div><div class="dialog-caption">{caption}</div></div>';
